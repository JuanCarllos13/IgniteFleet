...
import { getLastAsyncTimestamp } from "../../lib/ayncStorage/syncStorage";
...
export function Arrival() {
  ...
  useEffect(() => {
    getLastAsyncTimestamp().then((lastTimestamp) => {
      setDataNotSynced(historic!.updated_at.getTime() > lastTimestamp);
    });
  }, []);
